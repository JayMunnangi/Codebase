...
('C:\Program Files\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\Log\log_17.trc', default);
GO

---- Query to find the File Autogrowth and Shrink
...
-- Query to show Log growth and Shrinks
...
-- Query to show Errorlog , HASH WARNINGS , MISSING COLUMN STATS, MISSING JOIN PREDICATE , SORT WARNINGS ---
...
-- FULLTEXT events if any..

--- FT Crawl Aborted , Started , Stopped
...
WHERE   te.name = 'FT:Crawl Started'
		...
		--- OBJECT EVENTS --
--Objects altered , Created , Deleted.
...
--- SERVER START TIME AND STOP EVENTS
