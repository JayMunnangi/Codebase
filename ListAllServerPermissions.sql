/*
This Transact-SQL script list all server principals with their permissions on server level to give a quick overview of security.
For given permissions on server object like endpoints or impersonate other login it returns also the object / login etc name.

Works with SQL Server 2005 and higher versions in all editions.
Lists only object where the executing user do have VIEW METADATA permissions for.

Links:
  sys.server_permissions: http://msdn.microsoft.com/en-us/library/ms186260.aspx
*/
