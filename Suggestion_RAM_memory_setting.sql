...
,'EXEC sp_configure "show advanced options", 1;  GO RECONFIGURE; GO sp_configure ''max server memory'', ' + CAST(CAST(@memForSql * 1024 AS INT) AS VARCHAR(10)) + '; GO RECONFIGURE; GO ' AS CommandToExecute
,'Assumes dedicated instance. Only use the value after you verify it is reasonable.' 