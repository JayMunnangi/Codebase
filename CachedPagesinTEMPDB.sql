--Seeing big changes in TempDB commitment between one database and another could be a --sign of a wrongly sized TempDB, or indicate that one database is using TempDB in a --sub-optimal way.
